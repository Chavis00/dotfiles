...
--awful.util.tagnames = { " DEV ", " WEB ",  " CHAT "," ARCH ", " DOC ", " VBOX ", " MUS ", " VID "}
...
globalkeys = my_table.join(
    ...
    awful.key({ modkey, "Shift" }, "Return",
    function ()
        awful.spawn(string.format("rofi -i -show drun -modi drun -show-icons"))
	end,
    {description = "show dmenu", group = "hotkeys"}),
    ...
    awful.key({modkey, }, "p", function () awful.util.spawn("alacritty -e cmatrix") end),
    awful.key({modkey, }, "l", function () awful.util.spawn("xlock") end),
    awful.key({modkey, }, "n", function () awful.util.spawn("alacritty -e nvim") end),
    --awful.key({modkey, }, "m", function () awful.util.spawn("telegram-desktop")end),
   ...
   -- awful.key({ modkey }, "Right", function () lain.util.tag_view_nonempty(1) end,
    ...
    awful.key({ }, "XF86AudioMute",
        function ()
            ...
            beautiful.volume.update()
            awful.spawn("amixer -c 1 set Speaker playback 100% unmute")
        end),
