...
theme.wallpaper                                 = "/home/chavis/Pictures/wallpapers/noisy.png"
...
theme.layout_test                               = theme.dir .. "/icons/tile.png"
...
theme.weather = lain.widget.weather({
    city_id = 3435910, -- placeholder (Belgium)
...
function theme.at_screen_connect(s)
   ...
   s.quake = lain.util.quake({ app = "termite", height = 0.50, argname = "--name %s" })
    ...
    function custom_shape(cr, width, height)
        ...
        gears.shape.rounded_rect(cr, width, height, 1000)
    
        end
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "top", screen = s, height = 26, bg = theme.bg_normal, fg = theme.fg_normal, opacity=0.8,  shape = custom_shape ,  width=1880, border_width=15 })
